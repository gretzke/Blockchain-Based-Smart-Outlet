...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.startButton.setStyleSheet("color: rgb(50, 50, 50); background-color: rgba(0,255, 0, 0.75); border: none; font-size: 32px; border-radius:5px; font-weight: bold;")
        ...
        self.selectButton.setStyleSheet("color:rgb(50, 50, 50); background-color:white; border-radius: 4px; font-weight: bold; font-size: 20px")
        ...
        self.acceptPriceButton.setStyleSheet("color: rgb(50, 50, 50); background-color: rgba(0,255, 0, 0.75); border: none; font-size: 32px; border-radius:5px; font-weight: bold;")
        ...
        self.disconnectButton.setStyleSheet("color: white; background-color:rgba(255,0,0,0.5); border-radius: 4px; font-weight: bold; font-size: 20px")
...
"}")
        ...
        self.hourList.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        ...
        self.pcClosedButton.setStyleSheet("color: rgb(50, 50, 50); background-color: rgba(0,255, 0, 0.75); border: none; font-size: 32px; border-radius:5px; font-weight: bold;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.infoLabel.setText(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p><br/></p></body></html>", None, -1))
...
"Smart Socket", None, -1))
        ...
        self.acceptPriceButton.setText(QtWidgets.QApplication.translate("MainWindow", "Accept Price", None, -1))
        self.disconnectButton.setText(QtWidgets.QApplication.translate("MainWindow", "Disconnect", None, -1))
        self.ampsLabel.setText(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">TextLabel</span></p></body></html>", None, -1))
        self.hourLabel.setText(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p><span style=\" font-size:24pt;\">hours</span></p></body></html>", None, -1))
        self.infoCenterLabel.setText(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p><br/></p></body></html>", None, -1))
